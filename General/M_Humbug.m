...
% narrow O6
% designed using fdatool from the filter design toolbox (butterworth digital, stopband, IIR, Least Squares, 40-63Hz order 6)
...
switch MG.Disp.Ana.Filter.Humbug.Style
  case '50Hz'  % EUROPEAN MODE
    switch round(MG.DAQ.SR)
      ...
      case 31250
        b=[...
    0.995386247699319  -5.972013278489225  14.929576915653460  -19.905899769726052  14.929576915653460  -5.972013278489225  0.995386247699319 ...
       ];
        a = [...
        1.000000000000000  -5.990446012819222  14.952579842917430  -19.905857198474035  14.906552701679249  -5.953623115411301  0.990793782108932  ...
          ];
