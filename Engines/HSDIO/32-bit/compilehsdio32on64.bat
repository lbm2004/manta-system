:: MINIMAL SETUP FOR 32-BIT COMPILATION ON WINDOWS 64
setlocal
...
:: EXECUTE COMPILATION
cl /Fohsdio_stream_cont.obj  /O2 /Oy- /DNDEBUG niHSDIO.lib  libcmt.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ..\hsdio_stream_cont.c